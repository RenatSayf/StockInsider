...
class AdViewModelNewTest {

    @get:Rule
    var rule = ActivityScenarioRule(TestActivity::class.java)

    private lateinit var scenario: ActivityScenario<TestActivity>
    private lateinit var viewModel: AdViewModelNew

    @Before
    fun setUp() {
        scenario = rule.scenario
        scenario.onActivity {
            viewModel = ViewModelProvider(it)[AdViewModelNew::class.java]
        }
    }
    ...
    fun loadGoogleAd_not_disabled() {
        ...
        scenario.onActivity { activity ->
            ...
            viewModel.loadGoogleAd(indexId = 0, isOnExit = false, listener = object : AdViewModelNew.GoogleAdListener {
    ...
    fun loadYandexAd_not_disabled() {
        ...
        scenario.onActivity { activity ->
            ...
            viewModel.loadYandexAd(indexId = 0, isOnExit = false, listener = object: AdViewModelNew.YandexAdListener {
